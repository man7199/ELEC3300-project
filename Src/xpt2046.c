...
int Main_touchkey(void)
{
		strType_XPT2046_Coordinate strDisplayCoordinate;
	
	if ( XPT2046_Get_TouchedPoint ( & strDisplayCoordinate, & strXPT2046_TouchPara ) )
	{
		if ( ( strDisplayCoordinate .y > 40 ) && ( strDisplayCoordinate .y < 140 ) )
		{
			if ( ( strDisplayCoordinate .x > 10 ) && ( strDisplayCoordinate .x < 110 ) )
			{
				return 1;
			}
			else if ( ( strDisplayCoordinate .x > 120 ) && ( strDisplayCoordinate .x < 220 ) )
			{
				return 2;
			}}
		else if ( ( strDisplayCoordinate .y > 160 ) && ( strDisplayCoordinate .y < 260 ) ){
			 if ( ( strDisplayCoordinate .x > 10 ) && ( strDisplayCoordinate .x < 110 ) )
			{
				return 3;
			}
...
int Sub_touchkey(void)
{
		strType_XPT2046_Coordinate strDisplayCoordinate;
	
	if ( XPT2046_Get_TouchedPoint ( & strDisplayCoordinate, & strXPT2046_TouchPara ) )
	{
		if ( ( strDisplayCoordinate .y > 0 ) && ( strDisplayCoordinate .y < 50 ) )
		{
			if ( ( strDisplayCoordinate .x > 190 ) && ( strDisplayCoordinate .x < 240 ) )
			{
				return 1;
			}					
		}
...
int Draw_touchkey(int k){
	...
	if ( XPT2046_Get_TouchedPoint ( & strDisplayCoordinate, & strXPT2046_TouchPara ) )
	{
		if ( ( strDisplayCoordinate .y > 0 ) && ( strDisplayCoordinate .y < 50 ) )
		{
		 ...
		 if ( ( strDisplayCoordinate .y > 0 ) && ( strDisplayCoordinate .y < 30 ) ){
			 if ( ( strDisplayCoordinate .x > 50 ) && ( strDisplayCoordinate .x < 150 ) )
			{
				return 1;
			}
		...
		if(k==0){
		LCD_DrawBigDot(strDisplayCoordinate .x,strDisplayCoordinate .y,BLACK);
		}
		else if(k==1){
		LCD_DrawBigDot(strDisplayCoordinate .x,strDisplayCoordinate .y,RED);
		}
		else if(k==2){
		LCD_DrawBigDot(strDisplayCoordinate .x,strDisplayCoordinate .y,GREEN);

		}
		else if(k==3){
		LCD_DrawBigDot(strDisplayCoordinate .x,strDisplayCoordinate .y,BLUE);
		}
...
int Timer_touchkey(void)
{
	...
	if ( XPT2046_Get_TouchedPoint ( & strDisplayCoordinate, & strXPT2046_TouchPara ) )
	{
		if ( ( strDisplayCoordinate .y > 0 ) && ( strDisplayCoordinate .y < 50 ) )
		{
			...
			else if ( ( strDisplayCoordinate .x > 30 ) && ( strDisplayCoordinate .x < 130 ) )
			{
				return 4;
			}		
		}
		else if( ( strDisplayCoordinate .y > 270 ) && ( strDisplayCoordinate .y < 320 ) )
		{
			if ( ( strDisplayCoordinate .x > 10 ) && ( strDisplayCoordinate .x < 70 ) )
			{
				return 1;
			}
else if(			( strDisplayCoordinate .x > 80 ) && ( strDisplayCoordinate .x < 140 ) )
			{
				return 2;
			}
			else if(			( strDisplayCoordinate .x > 150 ) && ( strDisplayCoordinate .x < 210 ) )
			{
				return 3;
			}
		}
...
int Counter_touchkey(void)
{
	...
	else if( ( strDisplayCoordinate .y > 100 ) && ( strDisplayCoordinate .y < 220 ) )
		{
			if ( ( strDisplayCoordinate .x > 50 ) && ( strDisplayCoordinate .x < 170 ) )
			{
				return 4;
			}}
		}
...
int Counter_touchpad(void)
{
		strType_XPT2046_Coordinate strDisplayCoordinate;
	
	if ( XPT2046_Get_TouchedPoint ( & strDisplayCoordinate, & strXPT2046_TouchPara ) )
	{
		if ( ( strDisplayCoordinate .y > 40 ) && ( strDisplayCoordinate .y < 100 ) )
		{
			if ( ( strDisplayCoordinate .x > 0 ) && ( strDisplayCoordinate .x < 70 ) )
			{
				return 1;
			}		

			else if ( ( strDisplayCoordinate .x > 80 ) && ( strDisplayCoordinate .x < 150 ) )
			{
				return 2;
			}		
			else if ( ( strDisplayCoordinate .x > 160 ) && ( strDisplayCoordinate .x < 230 ) )
			{
				return 3;
			}		
		}
		else if ( ( strDisplayCoordinate .y > 110 ) && ( strDisplayCoordinate .y < 170 ) )
		{
			if ( ( strDisplayCoordinate .x > 0 ) && ( strDisplayCoordinate .x < 70 ) )
			{
				return 4;
	...
	else if ( ( strDisplayCoordinate .y > 180 ) && ( strDisplayCoordinate .y < 240 ) )
		{
			if ( ( strDisplayCoordinate .x > 0 ) && ( strDisplayCoordinate .x < 70 ) )
			{
				return 7;
		...
		else if ( ( strDisplayCoordinate .y > 250 ) && ( strDisplayCoordinate .y < 310 ) )
		{
			if ( ( strDisplayCoordinate .x > 0 ) && ( strDisplayCoordinate .x < 70 ) )
			{
				return 10;
...
int Counter_touchkey2(void)
{
	...
	if ( XPT2046_Get_TouchedPoint ( & strDisplayCoordinate, & strXPT2046_TouchPara ) )
	{
		...
		else if( ( strDisplayCoordinate .y > 110 ) && ( strDisplayCoordinate .y < 140 ) )
		{
			if ( ( strDisplayCoordinate .x > 20 ) && ( strDisplayCoordinate .x < 50 ) )
			{
				return 8;
			}
else if(			( strDisplayCoordinate .x > 60 ) && ( strDisplayCoordinate .x < 90 ) )
			{
				return 7;
			}
			else if(			( strDisplayCoordinate .x > 110 ) && ( strDisplayCoordinate .x < 140 ) )
			{
				return 6;}
			else if(			( strDisplayCoordinate .x > 150 ) && ( strDisplayCoordinate .x < 180 ) )
			{
				return 5;
			}
		}
		else if( ( strDisplayCoordinate .y > 170 ) && ( strDisplayCoordinate .y < 200 ) )
		{
			if ( ( strDisplayCoordinate .x > 20 ) && ( strDisplayCoordinate .x < 50 ) )
			{
				return 4;
